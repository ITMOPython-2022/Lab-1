...
* Используя функцию очищения консольного вывода (```os.system("cls")``` или ```os.system("clear")```), а также последовательности управления курсором, реализовать анимацию из 2-3 кадров.
